...
const crearLineaProducto = (url,nombre,precio,id) => {
    ...
    const contenido =
    `<a href="AluraGeek/screens/producto.html?id=${id}"><img class="product--img" src="../assets/img/${url}.png" alt="producto"></a>
    <p class="product--text">${nombre}</p>
    <p class="product--price">$${precio}</p>
    <a class="product--enlace" href="AluraGeek/screens/producto.html?id=${id}">Ver Producto</a>`;
